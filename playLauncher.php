...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	...
	echo '
				...
				name="Main" id="Main">
				<param name="allowScriptAccess" value="always" />
				<param name="movie" value="'.$LinkFlash.'Loading.swf?user='.$_SESSION['UserName'].'&key='.$_SESSION['k'].'&config='.$linksite.'/'.$_SESSION['lang'].'/config.xml" />
				<param name="quality" value="'.$qualidadeDdtank.'" />
				<param name="menu" value="false">
				<param name="bgcolor" value="#000000" />
				<param name="FlashVars" value="editby=" />
				<param name="allowScriptAccess" value="always" />
				<embed flashvars="editby=" src="'.$LinkFlash.'Loading.swf?user='.$_SESSION['UserName'].'&key='.$_SESSION['k'].'&config='.$linksite.'/'.$_SESSION['lang'].'/config.xml"
				width="1000px" height="600px" align="middle" quality="'.$qualidadeDdtank.'" name="Main" allowscriptaccess="always"
				type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</object>
