	...
	<body>
		...
		<div id="gwp-body">
			<div class="container">
				...
				<div class="logo"><a href=""><img src="./images/logo-nexus-index.png" /></a></div>
					...
					<br />
						...
						<form class="form" action="" method="POST" id="frmLogin">
								...
								<center>
									...
									require 'facebook/facebook.php'; 
										...
										$loginUrl = $facebook->getLoginUrl(array(
										   'scope' => $scopeFacebook,
										   'redirect_uri' => "{$linksite}/facebook.php",
										   ));
									}
								?>
									 <a href="<?=$loginUrl;?>" class="btn">Entrar com o facebook</a>
									
								<a href="javascript:void(0);" onclick="$('#form-login').slideUp(function() {$('#form-register').slideDown();});" class="btn" title="Criar Conta" alt="Criar Conta">Criar Conta</a><br>
								<br />
								...
								<a href="http://192.168.0.12:8080" target="_blank" class="btn" title="Servidor 2" alt="Servidor 2">Acessar Servidor 2</a><br>
														

								</div><?php if($painel==true){
									echo"
									<center>		<a href=\"{$linkpainel}\" target=\"_blank\" class=\"btn\" title=\"Painel\" alt=\"Painel\">Painel</a><br></center>";
						...
						<div id="form-register" class="form-signup" style="<?php if(!isset($text_r)) echo 'display:none';?>">
							...
							<h4>Para evitar problemas com Hackers, coloque um EMAIL valido para recuperar sua senha. <br> Atenciosamente Equipe DDTank</h4><br />
