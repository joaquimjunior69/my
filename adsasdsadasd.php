...
$ads = <<<EOF
			<!-- Banner flut -->
<div id='div-gpt-ad-1413909421316-1'>
<script type='text/javascript'>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1413909421316-1'); });
</script>
</div>
EOF;
$ads2 = <<<EOF
			<!-- Banner dentro da pagina do jogo -->
<div id='div-gpt-ad-1413909421316-0' style='width:300px; height:250px;'>
<script type='text/javascript'>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1413909421316-0'); });
</script>
</div>
...
<div class="pd-embed" id="pd1412703176788"></div>
<script type="text/javascript">
var _polldaddy = [] || _polldaddy;

_polldaddy.push( {
    type: 'slider',
    title: 'Participe de nossa pesquisa!',
    body: 'Participe da nossa enquete',
    button: 'Começar »',
    domain: 'vbrown15.polldaddy.com/s/',
    id: 'atualização',
    placeholder: 'pd1412703176788'
} );

(function(d,c,j){if(!document.getElementById(j)){var pd=d.createElement(c),s;pd.id=j;pd.src=('https:'==document.location.protocol)?'https://polldaddy.com/survey.js':'http://i0.poll.fm/survey.js';s=document.getElementsByTagName(c)[0];s.parentNode.insertBefore(pd,s);}}(document,'script','pd-embed'));
</script>
<noscript><a href="http://vbrown15.polldaddy.com/s/atualização">Participe de nossa pesquisa!</a></noscript>
			...
			<nav class="wow zoomin navbar navbar-default navbar-fixed-top" role="navigation">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a href="javascript:void(0);" onclick="getContentPage('topup');"> Comprar vip</font></a>
						</li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"></span> Linguagem para jogar<span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
